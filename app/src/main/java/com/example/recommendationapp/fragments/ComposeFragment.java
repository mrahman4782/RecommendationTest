...
import com.example.recommendationapp.MainActivity;
...
public class ComposeFragment extends Fragment {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(description.isEmpty()){
                    Toast.makeText(getContext(),"You need to have a desc",Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void launchCamera(){
        ...
        Uri fileProvider = FileProvider.getUriForFile(getContext(), "com.codepath.fileprovider.Place-Recommendation", photoFile);
